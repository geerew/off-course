...
{#if isMobile}
	<media-play-button
		class="bg-background-primary/60 relative inline-flex cursor-pointer items-center justify-center rounded-full p-3 ring-sky-400 outline-none ring-inset hover:text-white data-[focus]:ring-4"
	>
		<MediaPlayIcon
			class="group-hover:fill-background-primary group-hover:stroke-background-primary media-paused:block hidden size-7 fill-white stroke-white"
		/>
		<MediaPauseIcon
			class="group-hover:fill-background-primary group-hover:stroke-background-primary media-playing:block hidden size-7 fill-white stroke-white stroke-[2]"
		/>
	</media-play-button>
{:else}
