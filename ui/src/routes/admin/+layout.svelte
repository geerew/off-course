	...
	{#if menuPopupMode}
		<Dialog.Root bind:open={dialogOpen}>
			<Dialog.Portal>
				...
				<Dialog.Content
					class="border-foreground-alt-4 bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left fixed top-0 left-0 z-50 h-full w-[--settings-menu-width] border-r pt-4 pl-4"
				>
